<div class="flex-1 overflow-y-auto overflow-x-hidden bg-gray-200">
    @if ($updateMode)
        @include('livewire.blog.post-update')
    @else
            ...
            <div class="container mx-auto px-6 py-8">
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-8">
                        ...
                        <h4 class="text-gray-600">All Posts</h4>
                        {{-- form search --}}
                        <div class="relative mx-4 lg:mx-0">
                            ...
                            <input class="form-input w-32 rounded-md pl-10 pr-4 focus:border-indigo-600 sm:w-64"
                                type="text" placeholder="Search" wire:model.live="keywords">
                        </div>
                        {{-- form search --}}
                                    ...
                                    <tbody>
                                        @foreach ($posts as $post)
                                            <tr wire:key="{{ $post->id }}">
                                                ...
                                                <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                                    <p class="whitespace-no-wrap text-gray-900">{{ $post->title }}
                                                    </p>
                                                </td>
                                                <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                                    <p class="whitespace-no-wrap text-gray-900">
                                                ...
                                                <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                                    <p class="whitespace-no-wrap text-gray-900">{{ $post->status }}
                                                    </p>
                                                </td>
                                                <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
    ...
    @if ($confirmingDelete)
        <div class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-30">
            <div class="rounded bg-indigo-800 p-6 text-white shadow-md">
                <p class="text-lg">Are you sure, you want to delete {{ $postToDelete->name }}?</p>
