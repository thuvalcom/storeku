<div class="flex-1 overflow-y-auto overflow-x-hidden bg-gray-200">
    <main class="flex-1 overflow-y-auto overflow-x-hidden bg-gray-200">
        <div class="container mx-auto px-6 py-8">
            <h3 class="text-3xl font-semibold text-gray-700">Update Post</h3>
            <div class="mt-8">
                ...
                <div class="mt-4">
                    <div class="rounded-md bg-white p-6 shadow-md">
                        <h2 class="text-lg font-semibold capitalize text-gray-700">Update post</h2>
                        ...
                        <form wire:submit="update">
                            <div class="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <textarea class="form-input mt-2 w-full rounded-md focus:border-indigo-600" id="content" wire:model="content"></textarea>
                                </div>
                                @error('content')
                                    <em>{{ $message }}</em>
                                @enderror
                                ...
                                <div>
                                    <label class="text-gray-700" for="name">Keyword</label>
                                    <input class="form-input mt-2 w-full rounded-md focus:border-indigo-600"
                                        type="text" id="keyword" wire:model="keyword">
                                </div>
                                @error('keyword')
                                    <em>{{ $message }}</em>
                                @enderror
                                ...
                                <div>
                                    <label class="text-gray-700" for="post_category_id">Category</label>
                                    <select class="form-input mt-2 w-full rounded-md focus:border-indigo-600"
                                        id="post_category_id" wire:model="post_category_id">
                                ...
                                <div>
                                    ...
                                    <select class="form-select mt-2 w-full rounded-md focus:border-indigo-600"
