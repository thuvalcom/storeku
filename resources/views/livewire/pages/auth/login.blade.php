...
new #[Layout('layouts.guest')] class extends Component {
    ...
    public function login()
    {
        ...
        $productRedirect = session('product_redirect', RouteServiceProvider::HOME);

        // Redirect kembali ke halaman produk setelah login berhasil
        return $this->redirect($productRedirect, navigate: true);
    }
}; ?>
