<div class="flex-1 overflow-y-auto overflow-x-hidden bg-gray-200">
    <main class="flex-1 overflow-y-auto overflow-x-hidden bg-gray-200">
        <div class="container mx-auto px-6 py-8">
            ...
            <h3 class="text-3xl font-semibold text-gray-700">Site Settings</h3>

            <div class="mt-4">
                <h4 class="text-gray-600">Setting for website</h4>
                <div class="mt-4">
                        ...
                        <form wire:submit.prevent="save">
                            ...
                            <div class="border-b bg-gray-200 px-5 py-6 text-gray-700">
                                ...
                                <div class="relative mt-2 rounded-md shadow-sm">
                                    ...
                                    <input type="text"
                                        class="form-input w-full appearance-none rounded-md px-12 py-2 focus:border-indigo-600"
                                        wire:model="metaAuthor">
                                </div>
                            </div>
                            <div class="border-b bg-gray-200 px-5 py-6 text-gray-700">
                                <label class="text-xs">Meta Robots</label>

                                <div class="relative mt-2 rounded-md shadow-sm">

                                    <input type="text"
                                        class="form-input w-full appearance-none rounded-md px-12 py-2 focus:border-indigo-600"
                                        wire:model="metaRobots">
                                </div>
                            </div>
                            <div class="border-b bg-gray-200 px-5 py-6 text-gray-700">
                                <label class="text-xs">Google Site Verification</label>

                                <div class="relative mt-2 rounded-md shadow-sm">

                                    <input type="text"
                                        class="form-input w-full appearance-none rounded-md px-12 py-2 focus:border-indigo-600"
                                        wire:model="metaGoogleSiteVerification">
                                </div>
                            </div>
                            <div class="border-b bg-gray-200 px-5 py-6 text-gray-700">
                                <label class="text-xs">ads Code</label>
