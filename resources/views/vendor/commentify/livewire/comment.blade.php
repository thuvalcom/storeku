<div>
                                ...
                                @can('update', $comment)
                                    <li>
                                        <button wire:click="$toggle('isEditing')" type="button"
                                            class="block w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit
                                        </button>
                                    </li>
                                @endcan
                                @can('destroy', $comment)
    ...
    @if ($hasReplies)
        ...
        <article class="mb-1 ml-1 border-t border-gray-200 p-1 dark:border-gray-700 dark:bg-gray-900 lg:ml-12">
